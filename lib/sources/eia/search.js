import { interpretQuery, findCountryByCode, hasPhrase, normalizeSubmittedIntent, normalizeText } from "./interpret-query.js";
  ...
  try {
    ...
    const intent = req.query.intentReady === "1"
      ? normalizeSubmittedIntent({
          correctedQuery: req.query.intentCorrectedQuery,
          interpreter: req.query.intentInterpreter,
          countryCode: req.query.intentCountryCode,
          product: req.query.intentProduct,
          activity: req.query.intentActivity,
          frequency: req.query.intentFrequency
        }, query, countries)
      : await interpretQuery(query, countries);
