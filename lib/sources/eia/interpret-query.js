...
function addClarificationState(intent) {
  ...
  const blockingClarification = unresolvedQualifiers.length > 0 || missingFields.length > 0 || blockingAmbiguousFields.length > 0;
  ...
  const structuredIntent = {
    ...buildStructuredIntent(clarifiedIntent, clarifiedIntent.originalQuery),
    needsClarification,
    blockingClarification,
    missingFields,
