...
export function buildStructuredIntent(baseIntent, query) {
  ...
  const authoritativeQuery = baseIntent?.correctedQuery || baseIntent?.cleanedQuery || originalQuery;
  ...
  return {
    ...
    provenance: {
      query: baseIntent?.correctedQuery ? "validated_corrected_query" : "mechanically_cleaned_query",
