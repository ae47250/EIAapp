...
export function buildStructuredIntent(baseIntent, query) {
  ...
  const conceptPairResolution = buildOrderedConceptPairs(baseIntent, conceptMentions, product, activity, normalizedQuery);
  const conceptPairs = conceptPairResolution.pairs;
