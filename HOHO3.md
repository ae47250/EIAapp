...
Started: 2026-07-17T04:49:23.697Z
Completed: 2026-07-17T04:52:51.036Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `gpt-5.4-mini` | 30 | 30 | 0 | 36 | 0 | 0 | 0 | 89743.293 ms |
| `gpt-4.1-nano` | 30 | 29 | 1 | 36 | 0 | 0 | 0 | 114029.72 ms |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `gpt-5.4-mini` | 96 | 88/96 (91.7%) | 0/96 (0%) | 27 | 0 | 2/30 (6.7%) | 3203.244 ms | 4651.973 ms | activity_ai_ambiguous: 2; country_ai_ambiguous: 17; frequency_ai_ambiguous: 3; product_ai_ambiguous: 3; product_ai_rejected: 1; sector_ai_ambiguous: 1 |
| `gpt-4.1-nano` | 93 | 84/93 (90.3%) | 0/93 (0%) | 34 | 1 | 2/30 (6.7%) | 4538.453 ms | 6007.332 ms | activity_ai_missing: 1; activity_ai_rejected: 2; country_ai_ambiguous: 11; country_ai_missing: 4; frequency_ai_ambiguous: 2; frequency_ai_missing: 1; openai_validation_failed: 5; product_ai_ambiguous: 3; product_ai_missing: 1; product_ai_rejected: 3; sector_ai_rejected: 1 |
...
| Q27 | yes | yes | INTL.44-2-BRA-QBTU.A | INTL.44-2-BRA-QBTU.A | pending | none |
...
- Same warnings: 30/30.
- Raw AI-field disagreement before validation: 12/30.
...
- Timing: intent 2005.141 ms, deterministic retrieval/ranking 1350.741 ms, total 3356.1 ms.
...
- Mention order: geography=undefined:undefined@0; concepts=electricity:electricity@0 -> generation:generation@1; frequency=monthly:monthly@0.
- Timing: intent 1935.2 ms, deterministic retrieval/ranking 2241.982 ms, total 4177.258 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2232.971 ms, deterministic retrieval/ranking 1280.034 ms, total 3513.046 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| Route | domestic |
| Ambiguity | none |
| Fallback | country_ai_ambiguous, product_ai_ambiguous |
| Clarification | not required |
...
- Mention order: geography=undefined:undefined@0; concepts=total energy:total energy@0 -> consumption:consumption@1; frequency=monthly:monthly@0.
- Timing: intent 2546.619 ms, deterministic retrieval/ranking 2580.697 ms, total 5127.34 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2115.266 ms, deterministic retrieval/ranking 948.706 ms, total 3064.02 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> production:production@1; frequency=monthly:monthly@0.
- Timing: intent 1885.53 ms, deterministic retrieval/ranking 1785.028 ms, total 3670.606 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2366.687 ms, deterministic retrieval/ranking 116.426 ms, total 2483.16 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| Field provenance | AI value | Validated value | Status | Repair reason |
| --- | --- | --- | --- | --- |
| country | `none` | `NY` | fallback | country_ai_missing |
| product | `natural gas` | `natural gas` | approved | none |
| activity | `consumption` | `consumption` | approved | none |
| sector | `residential` | `residential` | approved | none |
| frequency | `monthly` | `monthly` | approved | none |
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> consumption:consumption@1; frequency=monthly:monthly@0.
- Timing: intent 2982.295 ms, deterministic retrieval/ranking 265.51 ms, total 3247.828 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2458.844 ms, deterministic retrieval/ranking 51.827 ms, total 2510.703 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| Route | domestic |
| Ambiguity | none |
| Fallback | country_ai_ambiguous, product_ai_rejected |
| Clarification | not required |

| Field provenance | AI value | Validated value | Status | Repair reason |
| --- | --- | --- | --- | --- |
| country | `none` | `IA` | fallback | country_ai_ambiguous |
| product | `renewable` | `wind` | fallback | product_ai_rejected |
| activity | `generation` | `generation` | approved | none |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `monthly` | `monthly` | approved | none |

- Mention order: geography=undefined:undefined@0; concepts=wind:wind@0 -> generation:generation@1; frequency=monthly:monthly@0.
- Timing: intent 2398.985 ms, deterministic retrieval/ranking 109.421 ms, total 2508.429 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2596.684 ms, deterministic retrieval/ranking 1229.406 ms, total 3826.225 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| activity | `none` | `none` | ambiguous | Energy is a broad term; unspecified activity (generation, consumption, etc.) |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `none` | `annual` | fallback | frequency_ai_ambiguous |

- Mention order: geography=undefined:undefined@0; concepts=renewable:renewable@0; frequency=none.
- Timing: intent 2285.189 ms, deterministic retrieval/ranking 1036.452 ms, total 3321.661 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2646.046 ms, deterministic retrieval/ranking 435.593 ms, total 3081.698 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| country | `none` | `TX` | fallback | country_ai_ambiguous |
| product | `natural gas` | `none` | ambiguous | The product term may refer to more than one approved energy-product family. |
| activity | `none` | `none` | ambiguous | No specific activity specified; could relate to consumption, production, reserves, etc. |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `none` | `annual` | fallback | frequency_ai_missing |

- Mention order: geography=undefined:undefined@0; concepts=none; frequency=none.
- Timing: intent 2078.568 ms, deterministic retrieval/ranking 502.383 ms, total 2580.98 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2056.713 ms, deterministic retrieval/ranking 1142.456 ms, total 3199.229 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> storage:storage@1; frequency=weekly:weekly@0.
- Timing: intent 2431.971 ms, deterministic retrieval/ranking 1937.815 ms, total 4369.813 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2003.468 ms, deterministic retrieval/ranking 1647.4 ms, total 3650.935 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=petroleum:petroleum@0 -> consumption:consumption@1; frequency=annual:annual@0.
- Timing: intent 4538.453 ms, deterministic retrieval/ranking 1468.846 ms, total 6007.332 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 1876.963 ms, deterministic retrieval/ranking 73.922 ms, total 1950.949 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=solar:solar@0 -> generation:generation@1; frequency=monthly:monthly@0.
- Timing: intent 1991.405 ms, deterministic retrieval/ranking 100.84 ms, total 2092.275 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2482.107 ms, deterministic retrieval/ranking 200.79 ms, total 2682.952 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| Route | international |
| Ambiguity | none |
| Fallback | product_ai_ambiguous, activity_ai_rejected, frequency_ai_ambiguous |
| Clarification | not required |
...
- Mention order: geography=undefined:undefined@0; concepts=renewable:renewable@0 -> production:production@1 -> renewable:renewable@2 -> consumption:consumption@3; frequency=none.
- Timing: intent 2478.232 ms, deterministic retrieval/ranking 223.09 ms, total 2701.353 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2141.089 ms, deterministic retrieval/ranking 200.416 ms, total 2341.546 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0 -> undefined:undefined@1; concepts=electricity:electricity@0 -> generation:generation@1; frequency=annual:annual@0.
- Timing: intent 1912.688 ms, deterministic retrieval/ranking 242.658 ms, total 2155.36 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> production:production@1; frequency=monthly:monthly@0.
- Timing: intent 2289.148 ms, deterministic retrieval/ranking 1407.586 ms, total 3696.768 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| Interpreter | openai |
| Cleaned query | `plz shwo montly nat gas prodction in Texas, not prices` |
| Corrected query | `show monthly natural gas production in Texas` |
| Confidence | 1 |
| Geography order | Texas (TX) |
| Product | natural gas |
| Product breadth / alternatives | specific; none |
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> production:production@1; frequency=monthly:monthly@0.
- Timing: intent 2564.117 ms, deterministic retrieval/ranking 1716.753 ms, total 4280.887 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| Model rank | Deterministic rank | Series / candidate | Title | Family | Route / pool / tier | Score | Frequency | Unit | Coverage | Ranking points | Reasons | Warnings |
| ---: | ---: | --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- | --- |
| 1 | 1 | `NG.N9050TX2.M` | Texas Natural Gas Marketed Production, Monthly | `domestic natural gas production other natural gas marketed production` | domestic / primary / A | 92.2 | monthly | Million Cubic Feet | 198901 to 202604 | productOrScope 22/22; activity 18/18; measureOrAggregation 8.3/15; fieldedLexical 20/20; frequency 5/5; currentness 3/3; availability 3/3 | tier_A, source_pool_primary, route_family_validated, geography_validated, product_or_scope_hard_gate_passed, activity_hard_gate_passed, negation_hard_gate_passed, frequency_validated, product_exact_natural_gas, activity_exact_production, ordinary_series, lexical_title_natural, lexical_title_gas, lexical_title_production, frequency_exact, current_active, availability_present, unrequested_subtype_qualifiers_1, equivalent_semantic_choice | none |
| 2 | 2 | `NG.NA1160_STX_2.M` | Texas Dry Natural Gas Production, Monthly | `domestic natural gas production other dry natural gas production` | domestic / primary / A | 92.2 | monthly | Million Cubic Feet | 200601 to 202412 | productOrScope 22/22; activity 18/18; measureOrAggregation 8.3/15; fieldedLexical 20/20; frequency 5/5; currentness 3/3; availability 3/3 | tier_A, source_pool_primary, route_family_validated, geography_validated, product_or_scope_hard_gate_passed, activity_hard_gate_passed, negation_hard_gate_passed, frequency_validated, product_exact_natural_gas, activity_exact_production, ordinary_series, lexical_title_natural, lexical_title_gas, lexical_title_production, frequency_exact, current_active, availability_present, unrequested_subtype_qualifiers_1, equivalent_semantic_choice | none |
| 3 | 3 | `NG.NA1150_STX_2.M` | Texas Natural Gas Plant Liquids Production, Monthly | `domestic natural gas plant production other natural gas plant liquids production` | domestic / primary / C | 89.7 | monthly | Million Cubic Feet | 199704 to 202412 | productOrScope 19.8/22; activity 18/18; measureOrAggregation 8.3/15; fieldedLexical 20/20; frequency 5/5; currentness 3/3; availability 3/3 | tier_C, source_pool_primary, route_family_validated, geography_validated, product_or_scope_hard_gate_passed, activity_hard_gate_passed, negation_hard_gate_passed, frequency_validated, product_exact_natural_gas, product_extra_concept_penalty, activity_exact_production, ordinary_series, lexical_title_natural, lexical_title_gas, lexical_title_production, frequency_exact, current_active, availability_present, unrequested_subtype_qualifiers_1 | product_contains_unrequested_concepts |
...
| country | `none` | `CA` | fallback | country_ai_ambiguous |
| product | `electricity` | `electricity` | approved | none |
| activity | `none` | `none` | ambiguous | No explicit activity stated. |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `monthly` | `monthly` | approved | none |

- Mention order: geography=undefined:undefined@0; concepts=electricity:electricity@0; frequency=monthly:monthly@0.
- Timing: intent 1659.081 ms, deterministic retrieval/ranking 549.848 ms, total 2208.963 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2140.187 ms, deterministic retrieval/ranking 805.127 ms, total 2945.342 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2146.874 ms, deterministic retrieval/ranking 159.293 ms, total 2306.188 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> prices:prices@1; frequency=annual:annual@0.
- Timing: intent 1952.833 ms, deterministic retrieval/ranking 197.41 ms, total 2150.334 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 1697.686 ms, deterministic retrieval/ranking 229.252 ms, total 1926.952 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=petroleum:petroleum@0 -> expenditures:expenditures@1; frequency=annual:annual@0.
- Timing: intent 1794.777 ms, deterministic retrieval/ranking 309.368 ms, total 2104.161 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> storage:storage@1; frequency=weekly:weekly@0.
- Timing: intent 2130.076 ms, deterministic retrieval/ranking 1553.292 ms, total 3683.386 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> storage:storage@1; frequency=weekly:weekly@0.
- Timing: intent 2275.721 ms, deterministic retrieval/ranking 1247.413 ms, total 3523.152 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2166.086 ms, deterministic retrieval/ranking 405.932 ms, total 2572.035 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0 -> undefined:undefined@1; concepts=natural gas:natural gas@0 -> production:production@1; frequency=monthly:monthly@0.
- Timing: intent 1950.258 ms, deterministic retrieval/ranking 492.557 ms, total 2442.838 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 1965.986 ms, deterministic retrieval/ranking 1227.929 ms, total 3193.936 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0 -> undefined:undefined@1; concepts=natural gas:natural gas@0 -> production:production@1; frequency=annual:annual@0.
- Timing: intent 3083.461 ms, deterministic retrieval/ranking 1657.296 ms, total 4740.782 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=petroleum:petroleum@0 -> consumption:consumption@1; frequency=annual:annual@0.
- Timing: intent 2012.145 ms, deterministic retrieval/ranking 113.027 ms, total 2125.186 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=petroleum:petroleum@0 -> consumption:consumption@1; frequency=annual:annual@0.
- Timing: intent 2122.94 ms, deterministic retrieval/ranking 207.196 ms, total 2330.153 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=petroleum:petroleum@0 -> consumption:consumption@1; frequency=annual:annual@0.
- Timing: intent 1964.871 ms, deterministic retrieval/ranking 113.449 ms, total 2078.334 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=petroleum:petroleum@0 -> consumption:consumption@1; frequency=annual:annual@0.
- Timing: intent 19559.963 ms, deterministic retrieval/ranking 154.659 ms, total 19714.686 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2102.554 ms, deterministic retrieval/ranking 1314.087 ms, total 3416.654 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=electricity:electricity@0 -> generation:generation@1; frequency=quarterly:quarterly@0.
- Timing: intent 1982.659 ms, deterministic retrieval/ranking 1476.859 ms, total 3459.542 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2005.036 ms, deterministic retrieval/ranking 10.813 ms, total 2015.861 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> production:production@1; frequency=weekly:weekly@0.
- Timing: intent 1913.846 ms, deterministic retrieval/ranking 9.913 ms, total 1923.786 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=electricity:electricity@0 -> generation:generation@1; frequency=monthly:monthly@0.
- Timing: intent 2101.939 ms, deterministic retrieval/ranking 87.4 ms, total 2189.351 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| Field provenance | AI value | Validated value | Status | Repair reason |
| --- | --- | --- | --- | --- |
| country | `none` | `none` | missing | No approved geography was found. |
| product | `electricity` | `electricity` | approved | none |
| activity | `generation` | `generation` | approved | none |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `monthly` | `monthly` | approved | none |
...
- Mention order: geography=undefined:undefined@0; concepts=electricity:electricity@0 -> generation:generation@1; frequency=monthly:monthly@0.
- Timing: intent 1997.134 ms, deterministic retrieval/ranking 90.011 ms, total 2087.16 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2412.753 ms, deterministic retrieval/ranking 1147.971 ms, total 3560.746 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| --- | --- | --- | --- | --- |
| country | `Brazil` | `BRA` | approved | none |
| product | `["petroleum","natural gas"]` | `natural gas` | fallback | product_ai_rejected |
| activity | `consumption` | `consumption` | approved | none |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `annual` | `annual` | approved | none |

- Mention order: geography=undefined:undefined@0; concepts=petroleum:petroleum@0 -> consumption:consumption@1 -> natural gas:natural gas@2 -> consumption:consumption@3; frequency=annual:annual@0.
- Timing: intent 2226.011 ms, deterministic retrieval/ranking 1952.866 ms, total 4178.894 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2529.98 ms, deterministic retrieval/ranking 691.017 ms, total 3221.012 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| Route | seds |
| Ambiguity | none |
| Fallback | country_ai_ambiguous, sector_ai_rejected |
| Clarification | not required |
...
| product | `natural gas` | `natural gas` | approved | none |
| activity | `consumption` | `consumption` | approved | none |
| sector | `residential, commercial` | `residential` | fallback | sector_ai_rejected |
| frequency | `annual` | `annual` | approved | none |

- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> consumption:consumption@1; frequency=annual:annual@0.
- Timing: intent 2094.805 ms, deterministic retrieval/ranking 1312.508 ms, total 3407.336 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| --- | --- | --- | --- | --- |
| country | `Brazil` | `BRA` | approved | none |
| product | `total energy` | `none` | ambiguous | The query says "energy consumption" without naming a specific fuel or energy product; mapped to the broadest allowed product only as a compatibility summary, while the request remains broad. |
| activity | `consumption` | `consumption` | approved | none |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `annual` | `annual` | approved | none |
...
- Timing: intent 3203.244 ms, deterministic retrieval/ranking 1448.686 ms, total 4651.973 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=total energy:total energy@0 -> consumption:consumption@1; frequency=annual:annual@0.
- Timing: intent 2199.169 ms, deterministic retrieval/ranking 1669.136 ms, total 3868.379 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Timing: intent 2305.274 ms, deterministic retrieval/ranking 23.125 ms, total 2328.415 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=solar:solar@0 -> generation:generation@1; frequency=weekly:weekly@0.
- Timing: intent 2507.393 ms, deterministic retrieval/ranking 22.368 ms, total 2529.776 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> storage:storage@1; frequency=weekly:weekly@0.
- Timing: intent 3350.963 ms, deterministic retrieval/ranking 1459.088 ms, total 4810.074 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| country | `United States` | `USA` | approved | none |
| product | `natural gas` | `natural gas` | approved | none |
| activity | `reserves` | `storage` | fallback | activity_ai_rejected |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `weekly` | `weekly` | approved | none |

- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0 -> storage:storage@1; frequency=weekly:weekly@0.
- Timing: intent 1926.73 ms, deterministic retrieval/ranking 1402.081 ms, total 3328.833 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| country | `none` | `TX` | fallback | country_ai_ambiguous |
| product | `natural gas` | `natural gas` | approved | none |
| activity | `none` | `none` | ambiguous | Conversion factor is not a supported activity value. |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `annual` | `annual` | approved | none |

- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0; frequency=annual:annual@0.
- Timing: intent 2435.933 ms, deterministic retrieval/ranking 1660.937 ms, total 4096.896 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
...
| country | `none` | `TX` | fallback | country_ai_ambiguous |
| product | `natural gas` | `natural gas` | approved | none |
| activity | `none` | `none` | ambiguous | No specific activity indicated |
| sector | `none` | `none` | missing | No approved sector was found. |
| frequency | `annual` | `annual` | approved | none |

- Mention order: geography=undefined:undefined@0; concepts=natural gas:natural gas@0; frequency=annual:annual@0.
- Timing: intent 2026.667 ms, deterministic retrieval/ranking 1026.757 ms, total 3053.444 ms.
- Pipeline versions: candidate `phase4a-v3`, ranking `phase4-v6`, taxonomy `phase4-concepts-v2`.
